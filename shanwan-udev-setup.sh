#!/bin/bash
# Run once with sudo to install the SHANWAN controller udev rule.
# Prerequisites: sudo apt install joystick

set -e

cat > /etc/udev/rules.d/99-shanwan-controller.rules << 'EOF'
